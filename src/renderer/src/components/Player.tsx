...
const Player = ({ isFocusModeActive, openFocusMode }: { isFocusModeActive: boolean, openFocusMode: () => void }): JSX.Element => {
  ...
  return (
    <>
      <PlayerSection isFocusModeActive={isFocusModeActive} isHovering={isHovering}>
      ...
      <ExtraControls isFocusModeActive={isFocusModeActive} isHovering={isHovering}>
        <Volume>
...
const PlayerSection = styled.section<{ isFocusModeActive: boolean, isHovering: boolean }>`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
  width: ${({isFocusModeActive}) => isFocusModeActive ? '35.5%' : 'auto'};
  position: ${({isFocusModeActive}) => isFocusModeActive ? 'absolute' : 'initial'};
  bottom: ${({isHovering}) => isHovering ? '17px' : '-70px'};
  left: ${({isFocusModeActive}) => isFocusModeActive ? '32.25%' : 'unset'};
  transition: 0.5s;
`;
...
const ExtraControls = styled.section<{ isFocusModeActive: boolean, isHovering: boolean }>`
  display: flex;
  justify-content: flex-end;
  align-items: center;
  margin-right: 20px;
  width: ${({isFocusModeActive}) => isFocusModeActive ? '33%' : 'initial'};
  position: ${({isFocusModeActive}) => isFocusModeActive ? 'absolute' : 'initial'};
  bottom: ${({isHovering}) => isHovering ? '38px' : '-52px'};
  right: ${({isFocusModeActive}) => isFocusModeActive ? '14px' : 'unset'};
  transition: 0.5s;
`;
