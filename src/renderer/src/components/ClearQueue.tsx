...
export const ClearQueue = (): JSX.Element => {
  ...
  return (
    <BigIcon onClick={clearQueue}>
      <ClearQueueIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">{/* Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. */}
